...
| ---- | ------------ | ------------ | ----------------------- | -------------- | ---------------------------------------------------------- | ---------------------------------------------------------- |
| 1    | 推荐         | 1            | index/recommend         | 底栏“首页”；2  | 顶栏“地图”—2；某组织—9；某活动—10                          | 80%(活动列表js) |
| 2    | 地图         | 2            | index/index-map         | 1              | 顶栏“推荐”—1；某活动—10                                    | — |
| 3    | 分区         | 3          | sections/sections-home  | 底栏“分区”     | 某版块—8；某组织—9                                         | 100%                        |
| 4    | 关注         | 7            | follows/follows-home    | 底栏“关注”     | 某组织—9；某活动—10                                        | 80%(活动列表js)                           |
...
| 10   | 活动详情     | 6            | sections/act-detail     | 1；2；4；9；12 |                                                            | 100% |
...
| 20 | 新建评论 | | sections/act-detail/new-comment | 10 | | 95%(显示原评论内容) |
